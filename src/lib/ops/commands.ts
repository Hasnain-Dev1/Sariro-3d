...
const ACTIONS: Record<QueueRole, Action[]> = {
  super_admin: [
    ...
    { label: 'Bank accounts', hint: 'The accounts families pay into, by country', href: sectionHref(SA, 'bank-accounts'), keywords: 'bank account transfer ifsc swift iban upi country' },
  ...
  hr: [
    ...
    { label: 'Bank accounts', hint: 'The accounts families pay into, by country', href: sectionHref(HR, 'bank-accounts'), keywords: 'bank account transfer ifsc swift iban upi country' },
