...
> = {
  ...
  /* Public Speaking is not here. It is five courses, one per age group, each
     with its own syllabus written alongside its lessons — lib/speaking/courses,
     read through speakingSyllabus(band). */
};
