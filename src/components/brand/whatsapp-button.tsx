...
export default function WhatsAppButton() {
  ...
  return (
    ...
    >
      ...
      <WhatsAppGlyph width={27} height={27} />
    </a>
  );
}

/**
 * The WhatsApp mark, shared.
 *
 * It is also used inside the booking form — the impatient path, for a parent
 * who wants an answer now rather than nine fields. One copy of the path so the
