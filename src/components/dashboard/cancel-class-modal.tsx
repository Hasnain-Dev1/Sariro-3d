 ...
 *
 * Role-aware cancellation. Teachers choose planned leave (zero pay) or an
 * HR-approved doubt session (full pay); students get a simple confirm (allowed
 * only >= 2h before a 1:1). The server enforces every rule — this UI just
 * collects intent and surfaces the policy error if one applies.
 */
      ...
      <div className="w-full max-w-md rounded-2xl bg-white p-6 shadow-xl">
        <div className="flex items-start justify-between mb-4">
          <div className="flex items-center gap-2">
            ...
            <h3 className="text-lg font-extrabold text-slate-900" style={{ fontFamily: 'var(--font-jakarta)' }}>Cancel class</h3>
          </div>
