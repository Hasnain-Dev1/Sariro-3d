...
/**
 * SARIRO — Coding & AI, its own page (/courses/coding)
 * ============================================================================
 * The founder, 18 Sep 2026: every subject on "What do you want to learn?"
 * opened its own page except Coding & AI, which only scrolled down to a
 * catalogue at the bottom of /courses. Now it is a page like the others; /courses
 * is the chooser, and old links to the catalogue (/courses?level=…,
 * /courses#catalog) are forwarded here.
 */
...
export default function CodingCoursesPage() {
  return (
    <Suspense>
      <CodingCoursesPageInner />
    </Suspense>
  );
}

function CodingCoursesPageInner() {
  ...
  return (
    <BrandLayout>
      <PageHero
        eyebrow="Coding & AI · any age"
        accentColor="#EA580C"
        breadcrumb="Learn · Coding & AI"
        variant="courses"
        title={
          <>
            Coding and AI, sorted by <span className="gradient-text">what you can already do.</span>
          </>
        }
        subtitle="Not tied to a grade. Four tracks, from first steps to shipping applications people actually use — every class live, capped at four learners, with a mentor who notices when you are stuck."
      >
        ...
        <Link href="/courses#learn" className="btn-tactile btn-tactile-light px-5 py-3 text-sm">
